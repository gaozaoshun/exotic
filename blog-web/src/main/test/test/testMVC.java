...
//@ContextConfiguration({"classpath*:/spring-mvc.xml"})    //配置文件
...
////        Assert.assertEquals("before/product/product_list",productController.list(null, null)) ;
//    }
//
//
//    /*
...
//        mockMvc.perform((
//        		post("http://127.0.0.1:10010/first/api/user")
//        		.characterEncoding("UTF-8")
//        		.param("username",new String[]{})
//        		))
//                .andDo(print()
//                ).andReturn();
//
